...
export const alertsAttributes = [
    ...
    },
    {
        ...
        description:
            (
                <>
                    Defines behavior on augmentation of a signature without certificates in its B-level.
                </>
            ),
        default:
            (
    ...
    },
    {
        ...
        description:
            (
                <>
                    Defines behavior on augmentation of a signature built only with self-signed certificate chains.
                </>
            ),
        default:
            (
