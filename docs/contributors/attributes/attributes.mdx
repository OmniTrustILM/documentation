...
Based on the usage and specific behaviour you want to provide, `Attribute` can be one of the following defined types in [AttributeType](https://github.com/CZERTAINLY/CZERTAINLY-Interfaces/blob/main/src/main/java/com/czertainly/api/model/common/attribute/v2/AttributeType.java):

| `AttributeType` | Class v2                                                                                                                                                                     | Class v3                                                                                                                                                                     | Short description                                                                                                                                                                     |
|-----------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `DATA`          | [`DataAttributeV2`](https://github.com/CZERTAINLY/CZERTAINLY-Interfaces/blob/main/src/main/java/com/czertainly/api/model/common/attribute/v2/DataAttributeV2.java)         | [`DataAttributeV3`](https://github.com/CZERTAINLY/CZERTAINLY-Interfaces/blob/main/src/main/java/com/czertainly/api/model/common/attribute/v3/DataAttributeV3.java)         | Full fledged data carriers used by in the platform for information exchange                                                                                                           |
...
| `CUSTOM`        | [`CustomAttributeV2`](https://github.com/CZERTAINLY/CZERTAINLY-Interfaces/blob/main/src/main/java/com/czertainly/api/model/common/attribute/v2/CustomAttributeV2.java)     | [`CustomAttributeV3`](https://github.com/CZERTAINLY/CZERTAINLY-Interfaces/blob/main/src/main/java/com/czertainly/api/model/common/attribute/v3/CustomAttributeV3.java)     | Used defined attributes for storing additional information about the objects supported in the platform                                                                                |
