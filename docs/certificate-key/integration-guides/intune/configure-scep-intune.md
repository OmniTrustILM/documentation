...
To integrate CZERTAINLY with registered application in [Authorize CZERTAINLY](./authorize-ilm.md), we need to create `SCEP Profile` that will be used to validate and process Intune requests.
