...
The identity of the authenticated user is forwarded to the identification service. To keep this hot path fast, `Core` caches successful authentication outcomes; see [Caching](../caching.md).
