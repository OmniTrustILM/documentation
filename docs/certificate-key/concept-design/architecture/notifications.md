...
- **Object**: Notification is sent to the recipient resolved from custom attributes of the object present in the notification message, via the notification instance's mapping attributes.
