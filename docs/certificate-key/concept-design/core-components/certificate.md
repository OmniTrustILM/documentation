...
In addition to classic certificates with only one public key, CZERTAINLY also supports hybrid certificates. Hybrid certificates are important tools for migration to post-quantum technology. They contain two public keys - the one with typically classic key algorithm and an alternative public key with quantum-safe algorithm. When such certificates signes another certificate, the signed certificate will also have corresponding alternative signature. The extensions for alternative public key, alternative signature and alternative signature algoritm are specified in [ITU-T X509 (10/2019)](https://www.itu.int/rec/T-REC-X.509-201910-I/en).
...
2. **Verify signature of certificate** using issuer public key - [Section 6.1.3 (a)(1)](https://datatracker.ietf.org/doc/html/rfc5280#section-6.1.3). If certificate has alternative signature, alternative signatured is validated as well - [ITU-T X509 (10/2019) Clause 7.2.2](https://www.itu.int/rec/T-REC-X.509-201910-I/en). 
