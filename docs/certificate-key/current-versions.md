...
|---------------|----------|----------------------------------------------------------|
| Administrator | `2.17.0` | `docker.io/czertainly/czertainly-frontend-administrator` |

## Connectors

| Connector                      | Version  | Docker Image                                                               |
|--------------------------------|----------|----------------------------------------------------------------------------|
| Common Credential Provider     | `1.4.0`  | `docker.io/czertainly/czertainly-common-credential-provider`               |
...
| Keycloak Theme    | `0.1.4`    | `docker.io/czertainly/czertainly-keycloak-theme`     |
